...
if (event.target.classList.contains('header-button')){
  ...
  HelloField[0].innerHTML = `Hello ${name}. Ready for more?`;
  document.querySelector('.header-button').setAttribute('style', "display:none");
}
// обработчики кнопок товаров
  ...
  document.querySelector('.airMacBuyForm').setAttribute('style', "display:none;");
  document.querySelector('.macBuyForm').setAttribute('style', "display:flex;");
...
<div class='commonMacBuyImg'></div>
  ...
  document.querySelector('.airMacBuyForm').setAttribute('style', "display:flex;");
  document.querySelector('.macBuyForm').setAttribute('style', "display:none;");
...
// обработчик селектора цвета товара
  ...
  if(document.querySelector('.commonMacSelect').value == 'BLACK'){
    document.querySelector('.commonMacBuyImg').setAttribute('style', 'background: url("./colorImg/blackCommonMac.jpg") 50% 50%;  background-size: cover; background-repeat: no-repeat;');
  }
  if(document.querySelector('.commonMacSelect').value == 'WHITE'){
    document.querySelector('.commonMacBuyImg').setAttribute('style', 'background: url("./colorImg/whiteCommonMac.jpg") 50% 50%; background-size: cover; background-repeat: no-repeat;');
  }
  if(document.querySelector('.commonMacSelect').value == 'RED'){
    document.querySelector('.commonMacBuyImg').setAttribute('style', 'background: url("./colorImg/redCommonMac.jpg") 50% 50%; background-size: cover; background-repeat: no-repeat;');
  }
}
